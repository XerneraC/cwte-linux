...
pkgbase=linux-cwte-515-starfive-vf2
...
cwte_vf2_tagname="JH7110_VF2_515_v${cwte_srcver}"
...
SRC_URI="
	...
	https://github.com/starfive-tech/linux/archive/refs/tags/${cwte_vf2_tagname}.tar.gz -> ${PF}_kern_pkg.tar.gz
	https://github.com/starfive-tech/soft_3rdpart/archive/refs/tags/${cwte_vf2_tagname}.tar.gz -> ${PF}_3rdpart_pkg.tar.gz
"
