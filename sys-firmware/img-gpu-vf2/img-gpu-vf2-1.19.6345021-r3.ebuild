...
vf2_sw_tag=JH7110_VF2_515_v3.9.3
...
"
SRC_URI="https://github.com/starfive-tech/soft_3rdpart/raw/${vf2_sw_tag}/IMG_GPU/out/img-gpu-powervr-bin-${PV}.tar.gz"
...
src_install() {
	...
	# install udev rules
	install -Dm644 "${FILESDIR}/90-img-gpu.rules" "${D}/lib/udev/rules.d/90-img-gpu.rules"
}
